...
- Windows (x86 and x64) and .NET Framework 4.7.2
  - https://github.com/maxim-saplin/CrossPlatformDiskTest/releases/download/2.0.2/CPDT.exe
...
- Android 4.4+ 
  ...
  - APK: https://github.com/maxim-saplin/CrossPlatformDiskTest/releases/download/2.0.2/com.Saplin.CPDT.apk
