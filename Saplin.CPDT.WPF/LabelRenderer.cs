...
using TextDecorations = Xamarin.Forms.TextDecorations;
using Color = Xamarin.Forms.Color;

[assembly: ExportRenderer(typeof(Xamarin.Forms.Label), typeof(Sapin.CPDT.WPF.CustomLabelRenderer))]

namespace Sapin.CPDT.WPF
{
	public class CustomLabelRenderer : ViewRenderer<Label, TextBlock>
	{
		bool _fontApplied;
