...
[assembly: ExportRenderer(typeof(Xamarin.Forms.WebView), typeof( Saplin.CPDT.UICore.Mac.WebViewRenderer2))]
...
namespace Saplin.CPDT.UICore.Mac
{
    ...
    public class WebViewRenderer2 : ViewRenderer<WebView, WebKit.WebView>, IWebViewDelegate, WebKit.IWebPolicyDelegate
    {
        ...
        {
            internal WebViewRenderer2 Renderer { private get; set; }
            internal FormsWebFrameDelegate(WebViewRenderer2 renderer)
            {
                Renderer = renderer;
            }
